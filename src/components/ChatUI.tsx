...
export const ChatUI = React.memo(function ChatUI({ isLocked, isTyping, setIsTyping }: { isLocked: boolean, isTyping: boolean, setIsTyping: (v: boolean) => void }) {
  ...
  return (
    <div 
      className="absolute bottom-0 md:bottom-24 landscape:bottom-0 xl:landscape:bottom-24 left-0 md:left-4 w-[100vw] sm:w-80 flex flex-col gap-1 pointer-events-none z-30 safe-ml transform scale-[0.45] sm:scale-100 origin-bottom-left landscape:scale-[0.45] md:landscape:scale-[0.8] xl:landscape:scale-100"
