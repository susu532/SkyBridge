...
export const BattleRoyaleSidebar: React.FC = () => {
  ...
  return (
    <div className="absolute right-0 md:right-4 landscape:right-0 xl:landscape:right-4 top-0 md:top-32 landscape:top-0 xl:landscape:top-24 flex flex-col gap-2 pointer-events-none mc-font transform scale-[0.15] sm:scale-75 xl:scale-100 origin-top-right safe-pr safe-pt landscape:scale-[0.15] md:landscape:scale-[0.65] xl:landscape:scale-100 pb-2">
