...
export const SkyCastlesSidebar: React.FC<SkyCastlesSidebarProps> = ({ isMobile }) => {
  ...
  return (
    <div 
      className={`absolute right-0 flex flex-col gap-2 pointer-events-none mc-font z-10 safe-pr safe-pt transition-all transform origin-top-right ${isMobile ? 'top-0 scale-[0.40] landscape:-top-6 landscape:scale-[0.16]' : 'top-0 sm:top-14 md:top-28 scale-[0.40] sm:scale-75 md:scale-90 lg:scale-100 landscape:scale-[0.40] md:landscape:scale-75 lg:landscape:scale-90 xl:landscape:scale-100'}`}
    >
